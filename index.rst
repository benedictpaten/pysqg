...
Pysqg (https://github.com/benedictpaten/pysqg) is a package implementing tools for the prototype 
...
As such we would like it to act as a superset format, enabling us to create a **Rosetta Stone** through which many existing formats
might be converted. 
...
The SQG format and Pysqg package have been designed to be: 
	...
	* Lightweight:
		...
		- It is easy to learn and use the associated tools with only a perfunctory knowledge of Python.
	...
	* Portable:
		- The SQG file format is based upon JSON. JSON parsers/writers are already available in many, many languages.
...
The remainder of this documentation is divided into several short chapters. 
	...
	* Firstly, a quick start tutorial that in 5 minutes should provide you with a working knowledge of Pysqg, without ever having to learn the syntax of the underlying SQG file format.
	* Secondly, a description of the SQG file format.
